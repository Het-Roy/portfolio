...
const PROJECTS = [
  ...
  },
  {
    title: 'Forme',
    description:
      'A responsive clone of the FORME fitness website showcasing premium smart fitness equipment, immersive layouts, and modern multi-page design.',
    github: 'https://github.com/Het-Roy/forme',
    live: 'https://hetroy-forme.netlify.app/',
    youtube: 'https://youtu.be/RglTlL59yaM?si=XhehuYrszVRkdpIn',
    tech: ['React', 'JavaScript'],
    color: '#84cc16',
    accentRGB: '132, 204, 22',
    previewImage: 'https://res.cloudinary.com/dwpjwccxd/image/upload/q_auto/f_auto/v1775801561/Screenshot_2026-04-10_114140_hh3aol.png',
  },
  {
    title: 'Big Basket',
    description:
    ...
    github: 'https://github.com/Het-Roy/BigBasket',
    live: 'https://hetroy-bigbasket.netlify.app/',
    youtube: 'https://youtu.be/DCbBqWksOBw?si=lpzlUOCaMsJzbFmH',
    tech: ['React', 'JavaScript'],
    color: '#84cc16',
    accentRGB: '132, 204, 22',
  ...
  },
  {
    title: 'GrowFitter',
    description:
      'A responsive clone of the Growfitter website featuring a modern fitness rewards platform with interactive UI, app-focused design, and engaging visuals.',
    github: 'https://github.com/Het-Roy/GrowFitter',
    live: 'https://hetroy-growfitter.netlify.app/',
    youtube: 'https://youtu.be/EO1JKEmEVFk?si=3SbFxEyuMVdX1NEi',
    tech: ['React', 'JavaScript'],
    color: '#84cc16',
    accentRGB: '132, 204, 22',
    previewImage: 'https://res.cloudinary.com/dwpjwccxd/image/upload/q_auto/f_auto/v1776339306/Screenshot_2026-04-16_170420_uy7f0y.png',
  },
  {
    ...
    github: 'https://github.com/Het-Roy/Hindustan-Times',
